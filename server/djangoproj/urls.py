...
urlpatterns = [
    ...
    path('api/login/', app_views.login_user, name='api_login'),
    path('api/register/', app_views.registration, name='api_register'),
    path('logout/', app_views.logout_request, name='logout'),
